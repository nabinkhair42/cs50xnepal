...
export function InfiniteMovingCardsDemo() {
  return (
    <>
    <h1 className="flex text-4xl font-black items-center justify-center">Testimonial</h1>

    <div className="h-[30rem] rounded-md flex flex-col antialiased dark:bg-black dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden py-8 sm:py-8">
      <InfiniteMovingCards
        items={testimonials}
        direction="left"
        speed="slow"
...
const testimonials = [
  ...
  {
    quote: "For me, CS50x been an enriching experience, providing me with a wealth of knowledge. CS50x is an exceptional course that offers high-quality content for free, providing tremendous value to students worldwide.",
